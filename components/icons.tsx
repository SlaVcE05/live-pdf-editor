...
export const SignatureIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M22 10.5c0 .8-2 2.2-4.5 2.2-1.4 0-2.8-.7-3.9-1.8-1.1-1.1-2-2.7-2.6-4.2-.7-1.8-1.3-3.6-2-5.4C8.4 1 6.9 1 6.9 1c0 0-1.8 1.4-1.8 4.4 0 3.1 1.3 6.3 4.4 6.3 3 0 4.1-2.2 4.1-2.2" />
        <path d="M16 18H4" />
    </svg>
);
